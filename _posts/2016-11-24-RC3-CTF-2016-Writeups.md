...
I watched [Monty Python and the Holy Grail](http://www.imdb.com/title/tt0071853/) a **long** time ago so I carefully watched the [clip](https://www.youtube.com/watch?v=cV0tCphFMr8) before proceeding.
...
Googling ths new joke we find an answer - ```cache``` - and prepend it to the name. 
